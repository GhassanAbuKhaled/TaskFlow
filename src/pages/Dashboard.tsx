              ...
              <>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-responsive-base text-muted-foreground">
                    {isDemoMode
                      ? "Try out TaskFlow features without creating an account. Your changes won't be saved permanently."
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 dashboard-stats-grid">
                  ...
                  >
                    <Card className="rounded-2xl border-border/50 shadow-soft hover:shadow-medium transition-all duration-300">
                      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 stat-card-header">
                ...
                <Card className="rounded-2xl border-border/50 shadow-soft">
                  ...
                  <CardContent>
                    <div className="flex flex-wrap gap-4">
                      <Link to="/create-task">
                        <Button className="rounded-2xl shadow-medium hover:shadow-large transition-all duration-300 w-[140px] h-10 font-medium">
                ...
                <Card className="rounded-2xl border-border/50 shadow-soft ">
                  <CardHeader className="flex flex-row items-center justify-between">
                    ...
                    <Link to="/tasks">
                      <Button variant="ghost" className="text-primary hover:text-primary/80 font-medium px-4">
